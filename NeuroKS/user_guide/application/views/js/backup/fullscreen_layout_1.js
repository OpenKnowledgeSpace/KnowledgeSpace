...
$(document).ready(function () 
{
    ...
    $("#panel-fullscreen").click(function (e) {
        ...
        if ($this.children('i').hasClass('glyphicon-resize-full'))
        {
            ...
            //alert("/NeuroKS/index.php/ViewAllData/view/"+pageName+"/0/0");
...
function loadButtons()
{
    ...
    if((array.indexOf("Physiology") > -1))
    {
     ...
     if(Physiology_count != null && Physiology_count > 0)
        html =  html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal\">Physiology ("+Physiology_count+")</button> </center></div><br/>";   
     else 
        html =  html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal\" disabled>Physiology ("+Physiology_count+")</button> </center></div><br/>";   
    ...
    if((array.indexOf("Expression") > -1))
    {
        if(sourceArray.indexOf("nif-0000-00130-1") > -1)
        {
            ...
            if(Expression_count != null && Expression_count > 0)
                html = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal2\">Expression ("+Expression_count+")</button></center></div><br/>";    
            else 
                html = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal2\" disabled>Expression ("+Expression_count+")</button></center></div><br/>";    
        }
    }
    if((array.indexOf("Models") > -1))     
    {
        ...
        if(Models_count != null && Models_count > 0)
            html  = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal5\">Models ("+Models_count+")</button></center></div><br/>";
        else 
            html  = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal5\" disabled>Models ("+Models_count+")</button></center></div><br/>";
        }
    }
    if((array.indexOf("Anatomy") > -1))     
    {
       if(sourceArray.indexOf("nif-0000-00054-1") > -1)
       {
            ...
            if(Anatomy_count != null && Anatomy_count > 0)
             html  = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal3\">Anatomy ("+Anatomy_count+")</center></div></div><br/>";
            else 
             html  = html+"\n<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal3\" disabled>Anatomy ("+Anatomy_count+")</button></center></div><br/>";
        }
    }
    if((array.indexOf("Morphology") > -1))     
    {
       if(sourceArray.indexOf("nif-0000-00006-1") > -1)
       {
            ...
            if(Morphology_count != null && Morphology_count > 0)
             html  = html+"<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal4\">Morphology ("+Morphology_count+")</button></center></div>";
            else 
             html  = html+"<div class=\"row\"><center><button style=\"height:30px;width:150px\" type=\"button\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#myModal4\" disabled>Morphology ("+Morphology_count+")</button></center></div>";
